...
<h2>¡Conozca nuestros
<span>PRODUCTOS y MATERIALES!</span></h2>
...
<div class="grid">
     <div class="col espe1"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/eco.png" alt="Logo"><p>TELA ECOLÓGICA</p></div>
    <div class="col espe2"><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/loneta.png" alt="Logo"><p>LONETA</p></div>
</div>
</div>
  ...
  <section id="bolsaspapel" class="template-section">
<div class="contenedor">

   
<div class="grid">
    <div class="col"> <p><span class="espe">•</span> Bolsas de papel kraft  <span class="espe">•</span> </p><img src="<?php echo get_stylesheet_directory_uri(); ?>/img/bolsa1.jpg" alt="Logo"></div>
...
<a href="https://ecobol.mx/catalogo"  class="btn"> <span>VER CATÁLOGO COMPLETO</span></a>
   ...
   <section id="estampado" class="template-section"> 
   <div class="contenedor">
  
   <div class="grid">
      
       <div class="col"></div>
        <div class="col especial"> <h2 class="verde">SERVICIO DE ESTAMPADO<span>
